...
Unity와 Android 간 데이터 교환을 위해 제공되는 **UnityPlayer.UnitySendMessage** 등의 **양방향 인터페이스를 활용하여 통신** 구조를 구성하여 Android에서 Unity로 메시지를 보내거나, Unity에서 Android 메서드를 직접 호출하는 방식으로 구현하였습니다. <br><br><br>
